...
# Script to build and run the Uniswap V3 Subgraph MCP Server locally in Docker
...
# Configuration
IMAGE_NAME="uniswap-v3-subgraph-mcp-server"
CONTAINER_NAME="uniswap-v3-subgraph-mcp-local"
HOST_PORT=8000
CONTAINER_PORT=8000

echo -e "${BLUE}🚀 Building and running Uniswap V3 Subgraph MCP Server...${NC}"
echo
...
echo
echo -e "${GREEN}✅ Uniswap V3 Subgraph MCP Server is running!${NC}"
echo
